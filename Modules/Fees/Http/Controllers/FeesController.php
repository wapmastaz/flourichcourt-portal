...
class FeesController extends Controller
{
    ...
    public function feesGroupStore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'name' => ['required', 'max:100', Rule::unique('fm_fees_groups', 'name')->where('academic_id', getAcademicId())],
            // "required|unique:fm_fees_groups,name|max:100",
        ]);
    ...
    {
        $validator = Validator::make($request->all(), [
            'name' => ['required', 'max:50', Rule::unique('fm_fees_types', 'name')->where('academic_id', getAcademicId())],
        ...
        try {
            ...
            $feesType->is_mandatory = ($request->is_mandatory == 'yes') ? 1 : 0;
