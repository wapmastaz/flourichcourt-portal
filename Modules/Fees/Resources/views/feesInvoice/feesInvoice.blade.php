                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12" id="selectStudentDiv">
                        ...
                        @if (isset($invoiceInfo))
                          @foreach ($students as $student)
                            <option value="{{ $student->id }}"
                              {{ $student->id == $invoiceInfo->student_id ? 'selected' : '' }}>{{ $student->full_name }}
                      ...
                      <div class="pull-right loader" id="selectStudentLoader"
                        ...
                        <img src="{{ asset('Modules/Fees/Resources/assets/img/pre-loader.gif') }}" alt=""
          ...
          <div class="row mt-30">
            <div class="col-lg-12">
              <div class="white-box pb-0 fees_invoice_type_div">
                <div class="row">
                  <div class="col-lg-12">
                    <select class="niceSelect w-100 bb form-control{{ $errors->has('fees_type') ? ' is-invalid' : '' }}"
              ...
              <div class="big-table">
                <table class="display school-table school-table-style fees_invoice_type_table" cellspacing="0"
                  width="100%">
                  <thead>
                    <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <input
                              ...
                              type="text" name="paid_amount[]" autocomplete="off" disabled
                          ...
                          <td>
                            ...
                            <button class="primary-btn icon-only fix-gr-bg" type="button" data-tooltip="tooltip"
                              title="@lang('common.delete')" id="deleteField">
                              ...
                              <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <div class="input-effect">
                                      <input class="primary-input form-control has-content" type="text"
