              ...
              <div class="white-box">
                <div class="add-visitor">
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12">
                      <select
                        class="niceSelect w-100 bb form-control{{ $errors->has('fees_group') || session()->has('message-exist') ? ' is-invalid' : '' }}"
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12">
                      <select
                        class="niceSelect w-100 bb form-control{{ $errors->has('is_mandatory') || session()->has('message-exist') ? ' is-invalid' : '' }}"
                        name="is_mandatory" id="is_mandatory" {{ isset($fees_master) ? 'disabled' : '' }}>
                        <option data-display="Mandatory" value="">Mandatory</option>
                        @if (isset($feesType))
                          <option value="yes"{{ $feesType->is_mandatory == 1 ? 'selected' : '' }}>
                            Yes </option>
                          <option value="no"{{ $feesType->is_mandatory == 0 ? 'selected' : '' }}>
                            No </option>
                        @else
                          <option value="yes" {{ old('is_mandatory') == 'yes' ? 'selected' : '' }}>
                            Yes </option>
                          <option value="no" {{ old('is_mandatory') == 'no' ? 'selected' : '' }}>
                            No </option>
                        @endif
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12">
                      <div class="input-effect">
                        <textarea class="primary-input form-control" cols="0" rows="4" name="description">{{ isset($feesType) ? $feesType->description : old('description') }}</textarea>
