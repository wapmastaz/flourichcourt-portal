...
if (!function_exists('feesInvoiceNumber')) {
    function feesInvoiceNumber($invoice)
    {
        ...
        $value = [
            ...
            Str::limit(($invoice->studentInfo->section) ? $invoice->studentInfo->section->section_name : '', $settings->section_limit),
...
if (!function_exists('healthCondition')) {
...
if (!function_exists('getRelations')) {
    ...
    {
        $relations = ['parent', 'father', 'mother', 'guardian'];
        return $relations;
    }
}
...
if(!function_exists('getAdmissionNumber')){
    function getAdmissionNumber($length = 8)
    {
        $characters = '1234567890';
        $charactersLength = strlen($characters);
        $randomString = '';
