...
class SmOnlineExamController extends Controller
{
    ...
    public function student_online_exam(Request $request)
    {
        ...
        try {
            ...
            $notification->user_id = ($teacher_info != null) ? $teacher_info->teacher->user_id : 'General';
            $notification->role_id = ($teacher_info != null) ? $teacher_info->teacher->role_id : 'General';
