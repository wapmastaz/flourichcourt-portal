        ...
        <div class="col-lg-6 col-md-8">
          <div class="form-wrap text-center">
            <div class="logo-container">
              <a href="{{ url('/') }}">
                <img src="{{ asset(generalSetting()->logo) }}" alt="" class="" style="max-width: 250px">
              </a>
            </div>

            <h5 class="text-uppercase mt-2">@lang('auth.login_details')</h5>
              ...
              <div class="form-group input-group mb-4">
                ...
                <div class="form-group input-group mb-4">
                  ...
                  <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="text"
                    name='email' id="email-address" placeholder="@lang('auth.enter_email_address')" value="{{ old('email') }}" />
                  @if ($errors->has('email'))
                ...
                <div class="form-group input-group mb-4">
                  ...
                  <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" type="password"
                    name='password' id="password" placeholder="@lang('auth.enter_password')" />
