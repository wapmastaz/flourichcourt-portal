    ...
    <div class="col-lg-12">
      ...
      <div class="row mt-25">
          ...
          <div class="row no-gutters input-right-icon">
            <div class="col">
              <div class="input-effect">
                <input class="primary-input form-control{{ @$errors->has('start_time') ? ' is-invalid' : '' }}"
        ...
        <div class="col-lg-6">
          <div class="row no-gutters input-right-icon">
            <div class="col">
              <div class="input-effect">
                <input class="primary-input  form-control{{ @$errors->has('end_time') ? ' is-invalid' : '' }}"
      ...
      <div class="row mt-15">
        <div class="col-lg-12">
          ...
          <div class="input-effect">
            <input type="checkbox" id="isBreak" class="common-checkbox" value="1" name="is_break"
            ...
            @if (isset($assigned_id))
              @foreach ($teachers as $teacher)
                <option value="{{ @$teacher->id }}"
                  {{ isset($teacher_detail) ? ($teacher_detail->id == $teacher->id ? 'selected' : '') : '' }}>
