              ...
              <div class="white-box">
                <div class="add-visitor">
                  ...
                  <div class="row mt-30">
                    ...
                    <div class="col-lg-12">
                      <div class="input-effect">
                        <input class="primary-input form-control{{ @$errors->has('capacity') ? ' is-invalid' : '' }}"
                          type="text" name="capacity" autocomplete="off"
                          value="{{ isset($section) ? $section->capacity : old('capacity') }}">
                        <label>@lang('common.capacity') <span>*</span></label>
                        <span class="focus-border"></span>
                ...
                <tbody>
                  @foreach ($sections as $section)
                    <tr>
                      ...
                      <td>{{ @$section->capacity }} student(s)</td>
                      @if (moduleStatusCheck('MultiBranch') && isset($branches))
                        <td></td>
                      @endif
                      <td>
