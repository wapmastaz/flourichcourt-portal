                    ...
                    <div class="col-lg-6 col-md-6">
                      ...
                      <div class="single-meta">
                        <div class="row">
                          ...
                          <div class="col-lg-6 col-md-6">
                            <div class="name">
                              {{ @$online_exam->category_type == 0 ? 'Admission' : 'Student' }}
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <table id="table_id" class="display school-table pb-120" cellspacing="0" width="100%">
                ...
                <tbody>
                  ...
                  @foreach ($question_banks as $question_bank)
                    ...
                    <tr class="abc">
                      <td>
                        <input data-id="{{ @$question_bank->id }}" type="checkbox"
                          id="question{{ @$question_bank->id }}" class="common-checkbox" name="questions[]"
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item modalLink" data-modal-size="modal-lg" title="View Question"
                              href="{{ route('view_online_question_modal', [$question_bank->id]) }}">@lang('common.view')</a>
                          </div>
                        </div>
                      </td>
                    </tr>
