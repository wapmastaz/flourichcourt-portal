            ...
            <div class="col-lg-12">
              ...
              <div class="white-box">
                <div class="add-visitor">
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12">
                      <select class="w-100 bb niceSelect form-control {{ $errors->has('category') ? ' is-invalid' : '' }}"
                        id="categorySelectStudentHomeWork" name="category">
                        <option data-display="@lang('common.select_category') *" value="">@lang('common.select_category') *</option>
                        @foreach ($categories as $category)
                          <option value="{{ $category->id }}"
                            {{ isset($online_exam) ? ($category->id == $online_exam->category_id ? 'selected' : '') : (old('category') == $category->id ? 'selected' : '') }}>
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12" id="category_type">
                      <select
                        class="w-100 bb niceSelect form-control{{ $errors->has('category_type') ? ' is-invalid' : '' }}"
                        id="categorySelect" name="category_type">
                        <option data-display="Exam For *" value="">Exam For *</option>
                        @if (isset($online_exam))
                          {{-- <option value="0" {{ $online_exam->category == 0 ? 'selected' : '' }}>
                            All</option> --}}
                          <option value="student" {{ $online_exam->category_type == 1 ? 'selected' : '' }}>
                            Student</option>
                          <option value="admission" {{ $online_exam->category_type == 0 ? 'selected' : '' }}>
                            Admission</option>
                        @else
                          {{-- <option value="0">
                            All</option> --}}
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12" id="subjectSelecttHomeworkDiv">
                      <select class="w-100 bb niceSelect form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}"
                  ...
                  <div class="row mt-25" id="section_group">
                    @if (isset($online_exam))
                  ...
                  <div class="row no-gutters input-right-icon mt-25">
                    <div class="col">
                      <div class="input-effect">
                        <input
                          class="primary-input date form-control{{ $errors->has('end_date') ? ' is-invalid' : '' }}"
                          id="end_date" type="text" name="end_date" autocomplete="off"
                    ...
                    <div class="col">
                      <div class="input-effect">
                        <input
                          ...
                          value="{{ isset($online_exam) ? $online_exam->start_time : old('start_time') }}">
                    ...
                    <div class="col-lg-12">
                      <div class="input-effect">
                        <input oninput="numberCheckWithDot(this)"
                          class="primary-input form-control{{ $errors->has('percentage') ? ' is-invalid' : '' }}"
                  ...
                  <div class="row mt-25">
                    <div class="col-lg-12">
                      <div class="input-effect">
                        <textarea class="primary-input form-control{{ $errors->has('instruction') ? ' is-invalid' : '' }}" cols="0"
                          rows="4" name="instruction">{{ isset($online_exam) ? $online_exam->instruction : old('instruction') }}</textarea>
                    ...
                    <div class="col-lg-12">
                      <div class="input-effect">
                        <input type="checkbox" id="auto_mark"
                          ...
                          {{ isset($online_exam) && $online_exam->auto_mark == 1 ? 'checked' : '' }} name="auto_mark"
                          value="1">
                  ...
                  @foreach ($online_exams as $online_exam)
                    <tr>
                      ...
                      <td>
                        ...
                        <br> @lang('exam.time'): {{ date('h:i A', strtotime($online_exam->start_time)) }}
                      ...
                      <td style="width: 30%">
                        <div class="dropdown d-flex">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            ...
                            @else
                              ...
                              @if (userPermission(241))
                                <a onclick="examDelete({{ $online_exam->id }})" href="javascript:void(0)"
                            ...
                            @if (!empty($is_set_online_exam_questions))
                              @if (userPermission(242))
                                ...
                                @if ($online_exam->status == 1)
                                  <a class="dropdown-item" href="{{ route('online_exam_close', [$online_exam->id]) }}">
                                    @lang('exam.close_exam')
                                  </a>
                                @endif
                              @endif
                            @endif
                          ...
                          @if (empty($is_set_online_exam_questions))
                            @if (userPermission(242))
                              <a class="primary-btn small bg-success text-white border-0 ml-3"
