...
{{ Form::open([
    ...
    'files' => true,
    'route' => 'online_exam_question_edit',
    'method' => 'POST',
      ...
      <div class="row  mt-25">
        <div class="col-lg-12">
          <div class="input-effect">
            <input oninput="numberCheck(this)" class="primary-input form-control" type="text" name="mark"
              autocomplete="off" value="{{ @$online_exam_question->mark }}" required>
    ...
    @if ($type == 'M')
      ...
      <div class="multiple-choice" id="multiple-choice">
        ...
        <div class="row  mt-25">
          <div class="col-lg-10">
            <div class="input-effect">
              <input oninput="numberCheck(this)" class="primary-input form-control" type="text"
                name="number_of_option" autocomplete="off" id="number_of_option_edit" value="{{ @$number_of_option }}">
      ...
      <div class="multiple-options" id="multiple-options">
        ...
        @foreach ($multiple_options as $multiple_option)
          ...
          <div class='row  mt-25'>
            <div class='col-lg-10'>
              <div class='input-effect'>
                <input class='primary-input form-control' type='text' name='option[]' autocomplete='off' required
            ...
            <div class='col-lg-2'>
              <button type='button'><input type='checkbox' name='option_check_{{ $i }}' value='1'
                  {{ @$multiple_option->status == 1 ? 'checked' : '' }}></button>
            </div>
          </div>
        @endforeach
            ...
            <div class="d-flex radio-btn-flex">
              <div class="mr-30">
                <input type="radio" name="trueOrFalse" id="relationFatherEdit" value="T"
                  class="common-radio relationButton" {{ @$online_exam_question->trueFalse == 'T' ? 'checked' : '' }}>
                <label for="relationFatherEdit">@lang('common.true')</label>
              </div>
              <div class="mr-30">
                <input type="radio" name="trueOrFalse" id="relationMotherEdit" value="F"
                  class="common-radio relationButton" {{ @$online_exam_question->trueFalse == 'F' ? 'checked' : '' }}>
