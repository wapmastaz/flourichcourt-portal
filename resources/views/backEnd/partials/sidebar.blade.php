        ...
        @if (Auth::user()->role_id != 2 && Auth::user()->role_id != 3)
          ...
          @if (userPermission(61) && menuStatus(61))
            <li data-position="{{ menuPosition(61) }}" class="sortable_li">
              ...
              <ul class="collapse list-unstyled" id="subMenuStudent">
                ...
                @endif
                @if (userPermission(64) && menuStatus(63))
                  <li data-position="{{ menuPosition(63) }}">
                    <a href="{{ route('student_admission_list') }}"> @lang('student.student_admission_list')</a>
                  </li>
                @endif
              ...
              <ul class="collapse list-unstyled" id="subMenuAccount">
                ...
                @if (userPermission(700) && menuStatus(700))
                  ...
                  <li data-position="{{ menuPosition(700) }}">
                    ...
                    <ul class="collapse list-unstyled {{ spn_nav_item_open($subMenuAccount, 'show') }}"
              ...
              <ul class="collapse list-unstyled" id="subMenuExam">
                ...
                @if ((userPermission(436) && menuStatus(436)) || (userPermission(706) && menuStatus(706)))
                  ...
                  <li>
                    ...
                    <ul class="collapse list-unstyled {{ spn_nav_item_open($subMenuExam, 'show') }}"
                      id="examSettings">
          ...
          @if (userPermission(417) && menuStatus(417))
            <li data-position="{{ menuPosition(417) }}" class="sortable_li">
              <a href="#subMenuUserManagement" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
