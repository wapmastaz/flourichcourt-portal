...
@section('title')
  @lang('student.student_admission_list')
@endsection
@section('mainContent')
    ...
    <div class="container-fluid">
      <div class="row justify-content-between">
        ...
        <div class="bc-pages">
          ...
          <a href="#">@lang('student.student_admission_list')</a>
        </div>
      </div>
    </div>
  </section>
                  ...
                  <select class="niceSelect w-100 bb form-control{{ $errors->has('academic_year') ? ' is-invalid' : '' }}"
                    ...
                    @foreach ($sessions as $session)
                      <option value="{{ $session->id }}"
                        {{ isset($academic) && $academic == $session->id ? 'selected' : '' }}>
  ...
  <div class="modal fade admin-query" id="grantStudentAdmissionModal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="mt-40 d-flex justify-content-between">
            ...
            <input type="hidden" name="id" value="{{ @$student->id }}" id="student_admission_i">
            {{-- using js in main.js --}}
    ...
    $(document).ready(function() {
      $('.data-table').DataTable({
        ...
        "ajax": $.fn.dataTable.pipeline({
          url: "{{ url('student-admission-list-datatable') }}",
          data: {
