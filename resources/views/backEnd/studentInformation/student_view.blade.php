    ...
    <div class="container-fluid p-0">
      <div class="row">
            ...
            <div class="white-box radius-t-y-0">
              ...
              <div class="single-meta">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="value">
                    @if ($student_detail->class != '' && $student_detail->session_id != '')
        ...
        <div class="col-lg-9 student-details up_admin_visitor">
          <ul class="nav nav-tabs tabs_scroll_nav mb-1" role="tablist">
            <li class="nav-item">
              <a class="nav-link  @if (Session::get('studentDocuments') != 'active' && Session::get('studentTimeline') != 'active') active @endif" href="#studentProfile" role="tab"
          ...
          <div class="tab-content">
                  ...
                  <div class="w-100">
                    ...
                    <div class="single-info">
                      <div class="row">
                        <div class="col-lg-4 col-md-6">
                          <div class="">
                            @lang('student.father_email')
                          </div>
                        </div>

                        <div class="col-lg-8 col-md-7">
                          <div class="">
                            {{ @$student_detail->parents->fathers_email_address }}
                          </div>
                        </div>
                      </div>
                    </div>
                            ...
                            @if (count($student_detail->studentLeave) > 0)
                              @foreach ($student_detail->studentLeave as $value)
                                <tr>
                                  ...
                                  <td class="nowrap">{{ $value->leave_from != '' ? dateConvert($value->leave_from) : '' }}
                                  </td>
                                  <td class="nowrap">{{ $value->leave_to != '' ? dateConvert($value->leave_to) : '' }}</td>
                                  <td class="nowrap">{{ $value->apply_date != '' ? dateConvert($value->apply_date) : '' }}
                                  </td>
                                  <td class="nowrap">
            ...
            <div role="tabpanel" class="tab-pane fade" id="studentExam">
              ...
              @if ($exam_count < 1)
                <div class="white-box no-search no-paginate no-table-info mb-2">
                  <table class="display school-table school-table-style shadow-none pb-0" cellspacing="0"
                    width="100%">
                    <thead>
                      <tr>
                        <th>
                        ...
                        @foreach ($get_results as $mark)
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {{-- @php
                                                    if (@$student_detail->optionalSubject!='') {
                                                        if (@$student_detail->optionalSubject->subject_id == $mark->subject->id) {
                                                            $optional_subject = 1;
                                                        if ($mark->total_gpa_point > @$student_detail->optionalSubjectSetup->gpa_above) {
                                                            $optional_gpa = @$student_detail->optionalSubjectSetup->gpa_above;
                                                        echo "GPA Above ".@$student_detail->optionalSubjectSetup->gpa_above;
                                                        echo "<hr>";
                                                        echo $mark->total_gpa_point  - @$student_detail->optionalSubjectSetup->gpa_above;
                                                        } else {
                                                            echo "GPA Above ".@$student_detail->optionalSubjectSetup->gpa_above;
                                                            echo "<hr>";
                                                            echo "0";
                      ...
                      <tr class="d-flex">
                        ...
                        <td class="col-4">
                          @if (file_exists($document->file))
                            <a class="primary-btn tr-bg text-uppercase bord-rad" href="{{ url($document->file) }}"
                              download>
                              @lang('common.download')<span class="pl ti-download"></span>
                            </a>
                          @endif
            ...
            <div role="tabpanel"
              ...
              <div class="white-box">
                ...
                @foreach ($student_detail->studentTimeline as $timeline)
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 mt-30">
                ...
                <input type="checkbox" id="currentAddressCheck" class="common-checkbox" name="visible_to_student"
                  value="1">
