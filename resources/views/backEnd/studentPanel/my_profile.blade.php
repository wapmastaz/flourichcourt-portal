            ...
            <div class="white-box radius-t-y-0">
              ...
              <div class="single-meta">
                <div class="d-flex justify-content-between">
                  ...
                  <div class="value">
                    {{ @$student_detail->class != '' ? @$student_detail->class->class_name : '' }}
                    ({{ @$student_detail->session_id != '' ? @$academic_year->year : '' }})
                  </div>
                </div>
              </div>
              <div class="single-meta">
              ...
              <div class="single-meta">
                <div class="d-flex justify-content-center">
                  @if (@$student_detail->status)
                    <span class="badge badge-pill badge-success px-4 py-2">Admitted</span>
                  @else
                    <span class="badge badge-pill badge-danger px-4 py-2">Admission Ongoing</span>
                  @endif
                </div>
              </div>
            </div>
                        ...
                        @if (count($leave_details) > 0)
                          @foreach ($leave_details as $value)
                            <tr>
                              ...
                              <td>
                                <a class="modalLink" data-modal-size="modal-md" title="@lang('common.view_leave_details')"
                                  href="{{ url('view-leave-details-apply', $value->id) }}"><button
                                    class="primary-btn small tr-bg"> @lang('common.view') </button></a>
                              </td>
                            </tr>
                          @endforeach
                        @else
                    ...
                    @foreach ($result_views as $result_view)
                      <tr>
                        ...
                        <td>
                          ...
                          @endphp
                          @if ($now >= $endTime)
                            <a class="btn btn-success modalLink" data-modal-size="modal-lg" title="Answer Script"
                              href="{{ route('student_answer_script', [@$result_view->online_exam_id, @$result_view->student_id]) }}">@lang('exam.answer_script')</a>
                          @else
                    ...
                    <div class="single-activity">
                      ...
                      <div class="sub-activity-box d-flex">
                        ...
                        <div class="close-activity">
                          @if (@$timeline->file != '')
                            <a href="{{ route('download-timeline-doc', showDocument(@$timeline->file)) }}"
                              class="primary-btn tr-bg text-uppercase bord-rad">
