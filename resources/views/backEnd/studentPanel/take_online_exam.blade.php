                    ...
                    <tr align="center" class="exam-bg">
                      <td colspan="2" class="pt-4 pb-3 px-sm-5">
                        ...
                        <h2><strong>@lang('common.subject') :
                          </strong>{{ @$online_exam->subject != '' ? @$online_exam->subject->subject_name : '' }}</h2>
                        <h6><strong>@lang('common.class_Sec') :
                          </strong>{{ @$online_exam->class != '' ? @$online_exam->class->class_name : '' }}
                          ({{ @$online_exam->section != '' ? @$online_exam->section->section_name : '' }})</h6>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <p class="mb-2"><strong>@lang('exam.exam_has_to_be_submitted_within'): </strong>{{ @$online_exam->date }}
                        ...
                        <td width="80%" class="pt-5">
                          ...
                          @if (@$question->questionBank->type == 'M')
                            ...
                            @foreach ($multiple_options as $multiple_option)
                              <div class="mt-20">
                                <input data-question="{{ @$question->question_bank_id }}" type="radio"
                                  data-option="{{ @$multiple_option->id }}" id="answer{{ @$multiple_option->id }}"
                                  class="common-checkbox answer_question_mu"
                                  name="options_{{ @$question->question_bank_id }}" value="{{ $multiple_option->id }}"
                            ...
                            <div class="row">
                              <div class="col-10">
                                <div class="input-effect mt-20">
                                  <textarea class="primary-input form-control mt-10 form_filler_{{ @$question->question_bank_id }}"
                              ...
                              <div class="col-2">
                                <p class="primary-btn fix-gr-bg" data-question="{{ @$question->question_bank_id }}"
                                  onclick="fillBlanks({{ @$question->question_bank_id }})">Fill</p>
                              </div>
                            </div>
                          @endif
                        </td>
