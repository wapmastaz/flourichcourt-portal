    ...
    <div class="wrapperAlert">
      ...
      <div class="contentAlert">
        ...
        <div class="topHalf">
          ...
          <h1>Admission in progress for your child</h1>
          <h3 class="text-white">{{ ucwords($student->full_name) ?? null }}</h3>
        ...
        <div class="bottomHalf">
          ...
          <div class="d-flex justify-content-center align-items-center">
            <a href="{{ url('/parent-dashboard') }}" class="btn success  rounded">Go To Dashboard</a>
