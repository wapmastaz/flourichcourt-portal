        ...
        <div class="container box-1420">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto">
              <li class="nav-item active"><a class="nav-link" href="{{ url('/') }}/home">Homse</a></li>
        ...
        <div class="col-lg-9">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="news-item">
                <div class="news-img">
                  <img class="img-fluid w-100" src="{{ asset('public/backEnd/img/client/news/news1.jpg') }}"
                    alt="">
                </div>
                <div class="news-text">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="news-item">
                <div class="news-img">
                  <img class="img-fluid w-100" src="{{ asset('public/backEnd/img/client/news/news2.jpg') }}"
                    alt="">
                </div>
                <div class="news-text">
                  <p class="date">17th Nov, 2018</p>
        ...
        <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="academic-item">
                <div class="academic-img">
                  <img class="img-fluid" src="{{ asset('public/backEnd/img/client/academics/academic1.jpg') }}"
                    alt="">
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="academic-item">
                <div class="academic-img">
                  <img class="img-fluid" src="{{ asset('public/backEnd/img/client/academics/academic2.jpg') }}"
                    alt="">
                </div>
                <div class="academic-text">
                  <h4>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="academic-item">
                <div class="academic-img">
                  <img class="img-fluid" src="{{ asset('public/backEnd/img/client/academics/academic3.jpg') }}"
                    alt="">
                </div>
                <div class="academic-text">
                  <h4>
          ...
          <div class="row">
              ...
              <div class="events-item">
                <div class="card">
                  <img class="card-img-top" class="img-fluid"
                    src="{{ asset('public/backEnd/img/client/events/event1.jpg') }}" alt="">
                  <div class="card-body">
                    <h5 class="card-title">
                      Structural study of
                      antibiotic opens the way
            ...
            <div class="col-lg-3 col-md-6">
              <div class="events-item">
                <div class="card">
                  <img class="card-img-top" class="img-fluid"
                    src="{{ asset('public/backEnd/img/client/events/event2.jpg') }}" alt="">
                  <div class="card-body">
                    <h5 class="card-title">
                      Structural study of
                      antibiotic opens the way
            ...
            <div class="col-lg-3 col-md-6">
              <div class="events-item">
                <div class="card">
                  <img class="card-img-top" class="img-fluid"
                    src="{{ asset('public/backEnd/img/client/events/event3.jpg') }}" alt="">
                  <div class="card-body">
                    <h5 class="card-title">
                      Structural study of
                      antibiotic opens the way
            ...
            <div class="col-lg-3 col-md-6">
              <div class="events-item">
                <div class="card">
                  <img class="card-img-top" class="img-fluid"
                    src="{{ asset('public/backEnd/img/client/events/event4.jpg') }}" alt="">
                  <div class="card-body">
                    <h5 class="card-title">
                      Structural study of
                      antibiotic opens the way
            ...
            <div class="d-flex justify-content-center">
              <div class="thumb">
                <img class="img-fluid rounded-circle"
                  src="{{ asset('public/backEnd/img/client/testimonial/person1.jpg') }}" alt="">
              </div>
          ...
          <aside class="f_widget ab_widget">
            ...
            <ul>
              <li><a href="#"></a>Infix Health Care</a></li><a href="#">
                <li><a href="#"></a>Infix Children’s Health
              </a></li>
