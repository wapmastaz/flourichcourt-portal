          ...
          <div class="banner_text">
            <div class="banner_text_iner">
              ...
              <a class="btn_1" target="_blank"
                href="mailto:support@spondonit.com?subject=Request for saas school demo!&body=This is only a test!"> <i
                  class="ti-email"></i> For Saas Demo</a>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="footer_area_text">
            ...
            <a href="https://codecanyon.net/item/infix-school-academic-management-system/23876323" class="footer_btn">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          <div class="copyright_text">
            <p> <img src="{{ asset('public/landing/img/copyright.svg') }}" alt="#"> 2019-2020 InfixEdu -
