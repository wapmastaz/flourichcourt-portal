...
use App\Http\Controllers\Parent\SmParentPanelController;
...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('online-exam-close/{id}', ['as' => 'online_exam_close', 'uses' => 'Admin\OnlineExam\SmOnlineExamController@onlineExamPublishClose']);
        ...
        Route::get('student-admission-list-datatable', ['as' => 'student_admission_list_datatable', 'uses' => 'DatatableQueryController@studentAdmissionDatatable'])->middleware('userRolePermission:64');
        ...
        Route::get('student-admissions-list', ['as' => 'student_admission_list', 'uses' => 'Admin\StudentInfo\SmStudentAdmissionController@studentAdmissionLists'])->middleware('userRolePermission:64');
        // student search
        ...
        // grant admission
        Route::post('grant-student-admission', [SmStudentAdmissionController::class, 'grantStudentAdmission'])->name('grant-student-admission')->middleware('userRolePermission:67');

        Route::post('bulk-grant-student-admission', [SmStudentAdmissionController::class, 'bulkGrantStudentAdmission'])->name('bulk-grant-student-admission')->middleware('userRolePermission:67');
    ...
    Route::post('/attendance/ajax-get-attendance-detail', [SmParentPanelController::class, 'ajaxGetAttendanceDetail']);
